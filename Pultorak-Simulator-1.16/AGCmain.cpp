...
/*****************************************************************************
REV2/26/16 "Port" to Microsoft Visual C++ 2015   S.BOTTS [SB]
added precompiled header "stdafx.h" and namspace std for console ouput
changed some string methods to _s mostly to suppress warnings.
*******************************************************************************
*/
...
void toggleBreakpoint()
{
	...
	{
		char b[80];
		strcpy_s(b, getCommand("Set breakpoint: -- enter 14-bit CADR (octal): ")); //[sb]
		cout << endl;
...
void toggleWatch()
{
	...
	{
		char b[80];
		strcpy_s(b, getCommand("Set watch: -- enter 14-bit CADR (octal): ")); // [sb]
		cout << endl;
		...
		char buf[100];
		sprintf_s(buf, "%06o:  %06o", watchAddr, oldWatchValue); // [sb]
		cout << buf << endl;
	}
	else
	{
...
{
	char cntrname[80];
	strcpy_s(cntrname, getCommand("Decrement counter: -- enter pcell (0-19): ")); //[sb]
	cout << endl;
...
{
	char iname[80];
	strcpy_s(iname, getCommand("Interrupt: -- enter priority (1-5): ")); //[sb]
	cout << endl;
